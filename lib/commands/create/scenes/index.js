...
module.exports = async () => {
  ...
  scenes.init(capitalize(_.camelCase(sceneName)), isRouter, routerName, isFunctional)
  ...
  if (directoryNumber === 0) {
    ...
    cssFiles.save(path.join(indexNamePair[directoryNumber].path, `${sceneName}/style.js`))
  } else {
    ...
    cssFiles.init('css/base-style-js-template.ejs')
    cssFiles.save(path.join(indexNamePair[directoryNumber].path, `scenes/${sceneName}/style.js`))
  }
