...
module.exports = async argv => {
  ...
  if (argv._.length !== 2) {
    ...
    try {
      ...
      directories.create(path.join(dirname, 'src/styles'))
      ...
      directories.create(path.join(dirname, 'src/components/use-form'))
      commonJsFile.init('js-files/form-template.ejs')
      commonJsFile.save('src/components/use-form/index.js')

      directories.create(path.join(dirname, 'src/components/form-component'))
      commonJsFile.init('js-files/form-component-template.ejs')
      commonJsFile.save('src/components/form-component/index.js')
      commonJsFile.init('js-files/form-component-style-template.ejs')
      commonJsFile.save('src/components/use-form/style.js')
      ...
      jsonFile.init('client-errors-codes-template.ejs')
      jsonFile.save(path.join(dirname, 'constants/client-errors-codes.json'))

      jsonFile.init('empty-json-template.ejs')
      jsonFile.save(path.join(dirname, 'constants/client-errors-codes-labels.json'))
      ...
      commonJsFile.init('styles/index.ejs')
      commonJsFile.save('src/styles/index.js')

      commonJsFile.init('styles/app.ejs')
      commonJsFile.save('src/styles/app.js')
      ...
      commonJsFile.init('redux/init/getters-global-template.ejs')
      ...
      commonJsFile.init('redux/init/action-types-global-template.ejs')
      commonJsFile.save('src/redux/action-types/global/index.js')
      ...
      directories.create(path.join(dirname, 'src/redux/sagas/feedback'))
      ...
      commonJsFile.init('redux/init/sagas-feedback-index-template.ejs')
      commonJsFile.save('src/redux/sagas/feedback/index.js')

      commonJsFile.init('redux/init/sagas-feedback-success-template.ejs')
      commonJsFile.save('src/redux/sagas/feedback/success.js')

      commonJsFile.init('redux/init/sagas-feedback-timeout-template.ejs')
      commonJsFile.save('src/redux/sagas/feedback/timeout.js')
