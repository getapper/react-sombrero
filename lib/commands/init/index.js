...
module.exports = async argv => {
  ...
  if (argv._.length !== 2) {
    ...
    try {
      ...
      directories.create(path.join(dirname, 'components/form'))
      commonJsFile.init('js-files/form-template.ejs')
      commonJsFile.save('components/form/index.js')
      ...
      directories.create(path.join(dirname, 'redux/action-types/ajax'))
      directories.create(path.join(dirname, 'redux/actions/ajax'))
      ...
      directories.create(path.join(dirname, 'redux/initial-states/routing'))
      directories.create(path.join(dirname, 'redux/reducers/routing'))
      directories.create(path.join(dirname, 'redux/actions/routing'))
      ...
      commonJsFile.save('redux/action-types/ajax/index.js')
      ...
      commonJsFile.save('redux/actions/routing/index.js')

      commonJsFile.init('empty-template.ejs')
      commonJsFile.save('redux/actions/ajax/index.js')
      ...
      commonJsFile.save('redux/initial-states/routing/index.js')
      ...
      commonJsFile.save('redux/reducers/routing/index.js')
